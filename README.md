...
2. Run an example (from the Control UI directory): `./makair-control --input=../makair-telemetry/records/few_fake_cycles_with_errors` (where `--input` is an UNIX file path)
