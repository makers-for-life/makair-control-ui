...
pub const DISPLAY_ALARM_CONTAINER_WIDTH_HAS_ALARMS_OFFSET: f64 = DISPLAY_ALARM_CONTAINER_MARGIN_LEFT_BASE;
...
pub const DISPLAY_ALARM_MESSAGE_WIDTH: f64 = 344.0;
...
pub const RUN_SETTINGS_MODAL_HEIGTH: f64 = 220.0;
