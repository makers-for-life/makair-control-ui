...
pub const DISPLAY_ALARM_CONTAINER_WIDTH: f64 = 460.0;
...
pub const TELEMETRY_WIDGET_SIZE_WIDTH: f64 = DISPLAY_WINDOW_SIZE_WIDTH as f64 / 3.0;
...
pub const LAYOUT_HEADER_SIZE_FULL_HEIGHT: f64 = DISPLAY_WINDOW_SIZE_HEIGHT as f64; // So the alarms can overflow the parent
