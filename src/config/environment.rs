...
pub const MODE_SETTINGS_MODAL_WIDTH: f64 = 600.0;
pub const MODE_SETTINGS_MODAL_HEIGTH: f64 = 464.0;
pub const MODE_SETTINGS_MODAL_FORM_PADDING_LEFT: f64 = 280.0;
pub const MODE_SETTINGS_MODAL_FORM_FIELD_HEIGHT_PADDED: f64 = 46.0;
pub const MODE_SETTINGS_SELECTOR_TABS_COUNT: usize = 4;
