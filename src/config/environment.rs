...
pub const DISPLAY_ALARM_CONTAINER_WIDTH: f64 = 340.0;
...
pub const DISPLAY_ALARM_MESSAGE_WIDTH: f64 = 202.0;
pub const DISPLAY_ALARM_MESSAGE_HEIGHT: f64 = 25.0;
...
pub const TELEMETRY_WIDGET_SIZE_WIDTH: f64 = 122.0;
pub const TELEMETRY_WIDGET_SIZE_HEIGHT: f64 = 74.0;
pub const TELEMETRY_WIDGET_SIZE_SPACING: f64 = 8.0;
pub const TELEMETRY_WIDGET_PADDING_LEFT: f64 = 16.0;
