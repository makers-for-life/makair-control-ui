...
widget_ids!(pub struct Ids {
  ...
  pressure_plateau_value_wrapper,
  ...
  mode_settings_alarm_threshold_low_expiratory_rate_text,
  mode_settings_alarm_threshold_low_expiratory_rate_value,
  mode_settings_alarm_threshold_low_expiratory_rate_value_wrapper,
  mode_settings_alarm_threshold_low_expiratory_rate_more,
  mode_settings_alarm_threshold_low_expiratory_rate_more_text,
  mode_settings_alarm_threshold_low_expiratory_rate_less,
  mode_settings_alarm_threshold_low_expiratory_rate_less_text,

  mode_settings_alarm_threshold_high_expiratory_rate_text,
  mode_settings_alarm_threshold_high_expiratory_rate_value,
  mode_settings_alarm_threshold_high_expiratory_rate_value_wrapper,
  mode_settings_alarm_threshold_high_expiratory_rate_more,
  mode_settings_alarm_threshold_high_expiratory_rate_more_text,
  mode_settings_alarm_threshold_high_expiratory_rate_less,
  mode_settings_alarm_threshold_high_expiratory_rate_less_text,
