...
widget_ids!(pub struct Ids {
  ...
  advanced_field_acceleration_factor_text,
  advanced_field_acceleration_factor_value,
  advanced_field_acceleration_factor_value_wrapper,
  advanced_field_acceleration_factor_more,
  advanced_field_acceleration_factor_more_text,
  advanced_field_acceleration_factor_less,
  advanced_field_acceleration_factor_less_text,
