  ...
  internal = rec {
    ...
    crates = {
      ...
      "instant" = rec {
        ...
        version = "0.1.3";
        edition = "2018";
        sha256 = "102v8wc3rynvk5s5gb9hw8d2q8m23gr508ilg9p5dal8xlm2s5gp";type = [ "cdylib" "rlib" ];
        authors = [
      ...
      "jpeg-decoder" = rec {
        ...
        version = "0.1.19";
        edition = "2015";
        sha256 = "011p6qbaj4gkykwp7kp3pdsmlbh0s792dhdwqnyimc0pw32b8isv";
        authors = [
      ...
      "makair-control" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "graph-scaler" ];
      };
      "malloc_buf" = rec {
      ...
      "rust-embed" = rec {
        ...
        resolvedDefaultFeatures = [ "compression" "include-flate" ];
      };
      "rust-embed-impl" = rec {
        ...
        resolvedDefaultFeatures = [ "compression" ];
      };
      ...
      "telemetry" = rec {
        ...
        src = pkgs.fetchgit {
          url = "https://github.com/makers-for-life/makair-telemetry";
          rev = "0fef5b94f407de3821737ca394ecd8308da8b3c5";
          sha256 = "18i0a9fn3q2cvzfvq5h8fvp8wnhfyi37m2ljxdi74jf1vmbsikjp";
        };
        authors = [
          "David Sferruzza <david.sferruzza@gmail.com>"
        ];
