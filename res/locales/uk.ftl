...
telemetry-label-ratio = Співвідн. Вдих-Видих
...
modal-mode-alarm-low-expiratory-rate = Частота видиху (низька)
modal-mode-alarm-high-expiratory-rate = Частота видиху (висока)
