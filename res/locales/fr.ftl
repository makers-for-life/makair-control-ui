...
telemetry-label-ratio = Durée de l'inspiration
...
modal-mode-time-inspiratory-minimum = Durée d'inspiration (min)
modal-mode-time-inspiratory-maximum = Durée d'inspiration (max)
modal-mode-flow-inspiratory = Débit inspiratoire
modal-mode-cycles-per-minute = Fréquence respiratoire
modal-mode-tidal-volume = Volume courant
modal-mode-plateau-duration = Durée de plateau
modal-mode-trigger-offset = Trigger inspiratoire
modal-mode-trigger-expiratory = Trigger expiratoire
modal-mode-alarm-low-inspiratory-minute-volume = Volume minute inspi. (min)
modal-mode-alarm-high-inspiratory-minute-volume = Volume minute inspi. (max)
modal-mode-alarm-low-expiratory-minute-volume = Volume minute expi. (min)
modal-mode-alarm-high-expiratory-minute-volume = Volume minute expi. (max)
modal-mode-alarm-low-respiratory-rate = Fréquence respiratoire (min)
modal-mode-alarm-high-respiratory-rate =Fréquence respiratoire (max)
modal-mode-alarm-low-tidal-volume = Volume courant (min)
modal-mode-alarm-high-tidal-volume = Volume courant (max)
modal-mode-alarm-leak = Volume de fuite (max)
modal-mode-alarm-peak-pressure = Pression de crête (max)
