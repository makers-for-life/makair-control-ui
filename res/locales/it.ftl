...
modal-pressure-plateau = Pressione di plateau:
modal-pressure-expiratory = Pressione espiratoria:
...
modal-mode-alarm-low-expiratory-rate = Tasso espiratorio (basso)
modal-mode-alarm-high-expiratory-rate = Tasso espiratorio (alto)
