...
modal-mode-time-inspiratory = Inspiratory duration
modal-mode-time-inspiratory-minimum = Inspiratory duration (min)
modal-mode-time-inspiratory-maximum = Inspiratory duration (max)
modal-mode-flow-inspiratory = Inspiratory flow
modal-mode-cycles-per-minute = Respiratory rate
modal-mode-tidal-volume = Tidal volume
modal-mode-plateau-duration = Plateau duration
modal-mode-trigger-offset = Inspiratory trigger
...
end-of-line-content-message-step-check-ui-screen = Please tap the continue button on the touch screen.
end-of-line-content-message-step-plug-air-test-system = The test lung should be connected. Tap continue.
end-of-line-content-message-step-reach-maximum-pressure = Increasing pressure, please wait. Do not press the test lung!
