...
modal-mode-alarm-low-inspiratory-minute-volume = Inspiratory volume (low)
modal-mode-alarm-high-inspiratory-minute-volume = Inspiratory volume (high)
modal-mode-alarm-low-expiratory-minute-volume = Expiratory volume (low)
modal-mode-alarm-high-expiratory-minute-volume = Expiratory volume (high)
modal-mode-alarm-low-expiratory-rate = Expiratory rate (low)
modal-mode-alarm-high-expiratory-rate = Expiratory rate (high)
modal-mode-alarm-low-tidal-volume = Tidal volume (low)
modal-mode-alarm-high-tidal-volume = Tidal volume (high)
